    ...
    <>
      ...
      {/* <div className="banner__container">
        <div className="banner__row">
          ...
          <div className="center__text">
            <div className="banner__container__paragraph">
              <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Beatae praesentium asperiores repudiandae, cumque molestias iure ea reiciendis tempora maxime dolor ad in animi optio iste reprehenderit qui aperiam officia provident!</p>
            </div>
          </div>
          <div className="banner__section">
            <div className="banner__section__div">
